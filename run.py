...
navbar = dbc.NavbarSimple(
    brand='Predicting Toronto Subway Delays',
    brand_href='/', 
    children=[
...
footer = dbc.Container(
    dbc.Row(
        dbc.Col(
            html.P(
                [
                    html.Span('Elliot Gunn', className='mr-2'), 
                    html.A(html.I(className='fas fa-envelope-square mr-1'), href='mailto:elliot.j.gunn@gmail.com'), 
                    html.A(html.I(className='fab fa-github-square mr-1'), href='https://github.com/elliotgunn/toronto-subway-delay'), 
                    html.A(html.I(className='fab fa-linkedin mr-1'), href='https://www.linkedin.com/in/elliotjgunn/'), 
                    html.A(html.I(className='fab fa-twitter-square mr-1'), href='https://twitter.com/elliot_j_g'), 
                ], 
                className='lead'
            )
        )
